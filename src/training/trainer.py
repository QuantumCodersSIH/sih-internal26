...
def f1_score(labels, predictions, average="macro"):
...
def roc_auc_score(labels, scores):
    ...
    # Class 1 (AI) should receive higher ranks when
    # its predicted score is higher.
...
def create_dataloaders():
    ...
    PROJECT_ROOT / "data" / "splits" / "train_expanded.csv",
